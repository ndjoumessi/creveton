...
//
// ─ Ici, côté console ─
// Sert au mode « Tester la question » du tiroir, qui est un vrai essai jouable
// (le relecteur clique, l'écran tranche). Un modérateur doit éprouver la
// question dans les conditions du joueur — sinon il valide une disposition que
// personne ne verra. L'APERÇU statique, lui, garde l'ordre canonique : c'est
// une vue de relecture, et un ordre qui bouge d'une ouverture à l'autre gênerait
// la comparaison avec le formulaire d'édition.
//
// ─ Duplication assumée ─
// Copie de `mobile/src/utils/shuffle.js`. Les deux applications ne partagent
// aucun paquet ; extraire vingt lignes en dépendance commune coûterait plus
// cher que de les tenir alignées. Toute correction ici doit être reportée là-bas.
