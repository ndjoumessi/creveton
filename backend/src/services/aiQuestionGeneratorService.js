...
function buildGenerationPrompt({ theme, level, count, samples }) {
  return (
    ...
    + '- ANCRAGE RÉGIONAL : quand le thème s\'y prête, privilégie un contenu ancré au '
    + 'Cameroun et en Afrique centrale (ex. sport → Lions Indomptables, CAN, sportifs '
    + 'africains ; géographie/histoire → Cameroun et région). Vise environ la moitié du '
    + 'lot avec un angle camerounais/africain ; le reste peut rester universel. '
    + 'N\'INVENTE JAMAIS un fait régional pour forcer l\'ancrage : dans le doute, choisis '
    + 'un fait universel vérifiable. Reste accessible au niveau demandé (pas de trivia obscure).\n'
    + '- Varie la position de la bonne réponse (utilise les 4 positions à peu près '
    + 'également ; pas toujours au même endroit).\n'
